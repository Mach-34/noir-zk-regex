...
use dep::sort::sort_advanced;
    {S_IS_ZERO_DEF}
    {SEQUENCE_DEF}
    {GET_INDEX_SEQUENCE_DEF}
    {EXTRACT_SUBSTRING_DEF}
    {MASK_MATCH_DEF}
    {REVERSE_VEC_DEF}
    {EXTRACT_S_PARAMS_FROM_TABLE_IMPL}
    {SPARSE_ARRAY_IMPL}
    "#
    )
}

const S_IS_ZERO_DEF: &str = r#"
...
const GET_INDEX_SEQUENCE_DEF: &str = r#"
...
/// Cost: 3.333 * N gates
pub(crate) fn get_index_sequence<let N: u32>(sequence: Sequence) -> [Field; N] {
...
const MAKE_S_NEXT_IS_0_DEF: &str = r#"
/**
 * Makes an S_NEXT_IS_0 table
 */
unconstrained fn make_s_next_is_0<let N: u32>(table: [Field; N]) -> [Field; N] {
    let mut s_next_is_0: [Field; N] = [0; N];
    for i in 1..N {
        s_next_is_0[i] = table[i] == 0;
    }
    s_next_is_0[0] = 1;
    s_next_is_0
}
...
const EXTRACT_S_PARAMS_FROM_TABLE_IMPL: &str = r#"
